...
$_internal_encoding = $ini_file['internal-encoding'];
$_lang_array = array (
...
if (!(mb_detect_order($ini_file['detect-order'])))
...
function mb_convert_encoding( $str, $to_encoding, $from_encoding = '')
{
	...
	switch (isset($_mb_encoding[$from_encoding])) {
		case 1: //euc-jp
...
*******************/
if (!$ini_file['convert-variables-arrayonly']) {
